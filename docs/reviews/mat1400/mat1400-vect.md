...
**Ronde 2 (relecture Opus, points 21-36)** : vect-005 — l'agent de relecture avait proposé $(1,1,1)$ comme distracteur avec un `why` faux (ni le produit ni la somme ne donnent $(1,1,1)$) ; revenu à $(1,1,0)$ avec `why` = "c'est $\vec u+\vec v$". vect-009 (Défi) jugé trop devinable (points symétriques $(1,0,0)/(0,1,0)/(0,0,1)$ donnant $x+y+z=1$ par pattern-matching) : changé pour $A(1,2,0)$, $B(0,1,1)$, $C(2,0,1)$, réponse $x+2y+3z=5$. vect-010 : difficulté surévaluée, $2\to1$. vect-011 : piège nommé explicitement (normales proportionnelles ≠ même plan). Relecture aveugle refaite sur vect-009 : voir résultat ci-dessous.
