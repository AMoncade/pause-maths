...
8 questions (mat1400-lagr-001 à 008). Relecture aveugle via `scripts/blind-review.ts` (seed 8),
vérification SymPy (résolution du système $\nabla f=\lambda\nabla g$, comparaison des
candidats). Verdicts comparés à la clé : accord total (8/8).

| id | verdict | notes |
|---|---|---|
| mat1400-lagr-001 | confirmé | système $y=\lambda,x=\lambda \Rightarrow x=y$ |
| mat1400-lagr-002 | confirmé | $f(5,5)=25$ |
...
| mat1400-lagr-006 | confirmé | $f(1,1)=f(-1,-1)=2$ |
